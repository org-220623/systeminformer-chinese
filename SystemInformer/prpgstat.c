    ...
    )
{
    ...
    PhAddIListViewGroup(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, L"其他");
    ...
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPUUSER, L"CPU (用户)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPUUSER);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPUKERNEL, L"CPU (内核)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPUKERNEL);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPUAVERAGE, L"CPU (均值)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPUAVERAGE);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPURELATIVE, L"CPU (相对)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPURELATIVE);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CYCLES, L"周期", (PVOID)PH_PROCESS_STATISTICS_INDEX_CYCLES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CYCLESDELTA, L"周期增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_CYCLESDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHES, L"上下文切换", (PVOID)PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHESDELTA, L"上下文切换增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHESDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_KERNELTIME, L"内核时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_KERNELTIME);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_KERNELDELTA, L"内核时间增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_KERNELDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_USERTIME, L"用户时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_USERTIME);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_USERDELTA, L"用户时间增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_USERDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_TOTALTIME, L"时间总计", (PVOID)PH_PROCESS_STATISTICS_INDEX_TOTALTIME);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_TOTALDELTA, L"时间总计增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_TOTALDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_PRIORITY, L"优先级", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIORITY);

    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTES, L"私有字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTESDELTA, L"私有字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTESDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATEBYTES, L"私有字节峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATEBYTES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_VIRTUALSIZE, L"虚拟大小", (PVOID)PH_PROCESS_STATISTICS_INDEX_VIRTUALSIZE);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKVIRTUALSIZE, L"虚拟大小峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKVIRTUALSIZE);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEFAULTS, L"页面错误", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEFAULTS);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEFAULTSDELTA, L"页面错误增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEFAULTSDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_HARDFAULTS, L"硬错误", (PVOID)PH_PROCESS_STATISTICS_INDEX_HARDFAULTS);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_HARDFAULTSDELTA, L"硬错误增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_HARDFAULTSDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_WORKINGSET, L"工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_WORKINGSET);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKWORKINGSET, L"工作集峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKWORKINGSET);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATEWS, L"私有工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATEWS);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_SHAREABLEWS, L"可共享工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_SHAREABLEWS);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_SHAREDWS, L"已共享工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_SHAREDWS);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEDPOOL, L"分页池字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEDPOOL);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKPAGEDPOOL, L"分页池字节峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKPAGEDPOOL);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_NONPAGED, L"非分页池字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_NONPAGED);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKNONPAGED, L"非分页池字节峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKNONPAGED);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_SHAREDCOMMIT, L"已共享提交", (PVOID)PH_PROCESS_STATISTICS_INDEX_SHAREDCOMMIT);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMIT, L"私有提交", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMIT);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATECOMMIT, L"私有提交峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATECOMMIT);
    //PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMITLIMIT, L"私有提交限制", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMITLIMIT);
    //PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_TOTALCOMMITLIMIT, L"提交限制总计", (PVOID)PH_PROCESS_STATISTICS_INDEX_TOTALCOMMITLIMIT);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEPRIORITY, L"页面优先级", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEPRIORITY);

    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READS, L"读取", (PVOID)PH_PROCESS_STATISTICS_INDEX_READS);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READSDELTA, L"读取增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_READSDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READBYTES, L"读取字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_READBYTES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READBYTESDELTA, L"读取字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_READBYTESDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITES, L"写入", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITESDELTA, L"写入增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITESDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITEBYTES, L"写入字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITEBYTES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITEBYTESDELTA, L"写入字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITEBYTESDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHER, L"其他", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHER);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHERDELTA, L"其他增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHERDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHERBYTES, L"其他字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHERBYTES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHERBYTESDELTA, L"其他字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHERBYTESDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOTOTAL, L"总计字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOTOTAL);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOTOTALDELTA, L"总计字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOTOTALDELTA);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOAVERAGE, L"总计字节 (均值)", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOAVERAGE);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOPRIORITY, L"I/O 优先级", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOPRIORITY);

    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_HANDLES, L"句柄", (PVOID)PH_PROCESS_STATISTICS_INDEX_HANDLES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_PEAKHANDLES, L"句柄峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKHANDLES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_GDIHANDLES, L"GDI 对象句柄", (PVOID)PH_PROCESS_STATISTICS_INDEX_GDIHANDLES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_PEAKGDIHANDLES, L"GDI 对象句柄峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKGDIHANDLES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_USERHANDLES, L"用户对象句柄", (PVOID)PH_PROCESS_STATISTICS_INDEX_USERHANDLES);
    PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_PEAKUSERHANDLES, L"用户对象句柄峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKUSERHANDLES);

    if (WindowsVersion >= WINDOWS_10_RS3)
    {
        PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_RUNNINGTIME, L"运行时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_RUNNINGTIME);
        PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_SUSPENDEDTIME, L"挂起时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_SUSPENDEDTIME);
        PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_HANGCOUNT, L"挂起计数", (PVOID)PH_PROCESS_STATISTICS_INDEX_HANGCOUNT);
        PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_GHOSTCOUNT, L"幽灵计数", (PVOID)PH_PROCESS_STATISTICS_INDEX_GHOSTCOUNT);
        //PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_DISKREAD, L"读取字节", NULL);
        //PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_DISKWRITE, L"写入字节", NULL);
        PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_NETWORKTXRXBYTES, L"网络发送/接收字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_NETWORKTXRXBYTES);
        //PhAddIListViewGroupItem(Context->ListView, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_MBBTXRXBYTES, L"移动宽带发送/接收字节", NULL);
    }
