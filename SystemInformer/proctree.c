    ...
    )
{
    ...
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_VIRTUALSIZE, FALSE, L"虚拟内存", 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PEAKVIRTUALSIZE, FALSE, L"虚拟内存峰值", 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
