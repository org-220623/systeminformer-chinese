    ...
    case WM_INITDIALOG:
        {
            ...
            PhSetControlTheme(context->ListViewHandle, L"explorer");
            PhAddListViewColumn(context->ListViewHandle, 0, 0, 0, LVCFMT_LEFT, 145, L"名称");
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 225, L"值");
            PhSetExtendedListView(context->ListViewHandle);
            IListView_EnableGroupView(context->ListViewClass, TRUE);

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, L"共享 Winsock 上下文");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_STATE, L"套接字状态");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_TYPE, L"套接字类型");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_ADDRESS_FAMILY, L"地址家族");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_PROTOCOL, L"协议");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_CATALOG_ENTRY_ID, L"目录条目 ID");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_PROVIDER_ID, L"提供者 ID");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_PROVIDER_FLAGS, L"提供者标志");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_SERVICE_FLAGS, L"服务标志");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_SEND_TIMEOUT, L"发送超时");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_RECEIVE_TIMEOUT, L"接收超时");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_SEND_BUFFER_SIZE, L"发送缓冲区大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_RECEIVE_BUFFER_SIZE, L"接收缓冲区大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_CREATION_FLAGS, L"创建标志");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SHARED, PH_AFD_SOCKET_ITEM_FLAGS, L"标志");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_ADDRESSES, L"地址");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_ADDRESSES, PH_AFD_SOCKET_ITEM_ADDRESS, L"本地地址");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_ADDRESSES, PH_AFD_SOCKET_ITEM_REMOTE_ADDRESS, L"远程地址");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, L"AFD 信息类");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_CONNECT_TIME, L"连接时间");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_DELIVERY_AVAILABLE, L"可交付");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_PENDED_RECEIVE_REQUESTS, L"挂起的接收请求");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_SENDS_PENDING, L"挂起的发送");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_RECEIVE_WINDOW_SIZE, L"接收窗口大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_SEND_WINDOW_SIZE, L"发送窗口大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_MAX_SEND_SIZE, L"最大发送大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_GROUP_ID, L"组 ID");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_INFOCLASS, PH_AFD_SOCKET_ITEM_GROUP_TYPE, L"组类型");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_TDI, L"TDI 设备");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TDI, PH_AFD_SOCKET_ITEM_TDI_ADDRESS_DEVICE, L"TDI 地址设备");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TDI, PH_AFD_SOCKET_ITEM_TDI_CONNECTION_DEVICE, L"TDI 连接设备");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, L"套接字级别选项");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_REUSEADDR, L"重用地址");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_KEEPALIVE, L"保持活动");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_DONTROUTE, L"不路由");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_BROADCAST, L"广播");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_OOBINLINE, L"带外路由");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_RCVBUF, L"接收缓冲区大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_MAX_MSG_SIZE, L"最大消息长度");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_PAUSE_ACCEPT, L"暂停接收");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_COMPARTMENT_ID, L"区间 ID");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_RANDOMIZE_PORT, L"随机端口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_PORT_SCALABILITY, L"端口可扩展性");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_REUSE_UNICASTPORT, L"重用单播端口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_SO, PH_AFD_SOCKET_ITEM_SO_EXCLUSIVEADDRUSE, L"独占地址使用");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, L"IP 级别选项");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_HDRINCL, L"包含的头部");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_TOS, L"服务类型");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_TTL, L"单播 TTL");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_MULTICAST_IF, L"多播接口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_MULTICAST_TTL, L"多播 TTL");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_MULTICAST_LOOP, L"多播环回");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_DONTFRAGMENT, L"不分片");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_PKTINFO, L"接收数据包信息");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECVTTL, L"接收 TTL");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECEIVE_BROADCAST, L"广播接收");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_PROTECTION_LEVEL, L"IPv6 保护级别");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECVIF, L"接收到达接口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECVDSTADDR, L"接收目标地址");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_V6ONLY, L"仅 IPv6");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_IFLIST, L"接口列表");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_UNICAST_IF, L"单播接口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECVRTHDR, L"接收路由报头");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECVTOS, L"接收服务类型");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_ORIGINAL_ARRIVAL_IF, L"原始到达接口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECVECN, L"接收 ECN");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_PKTINFO_EX, L"接收扩展数据包信息");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_WFP_REDIRECT_RECORDS, L"WFP 重定向记录");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_WFP_REDIRECT_CONTEXT, L"WFP 重定向上下文");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_MTU_DISCOVER, L"MTU 发现");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_MTU, L"路径 MTU");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_RECVERR, L"接收 ICMP 错误");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_IP, PH_AFD_SOCKET_ITEM_IP_USER_MTU, L"MTU 上限");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, L"TCP 级别选项");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_NODELAY, L"无延迟");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_EXPEDITED, L"加速数据");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_KEEPALIVE, L"保持活动");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_MAXSEG, L"最大段大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_MAXRT, L"重试超时");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_STDURG, L"URG 解释");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_NOURG, L"无 URG");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_ATMARK, L"标记位置");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_NOSYNRETRIES, L"无 SYN 重试");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_TIMESTAMPS, L"时间戳");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_CONGESTION_ALGORITHM, L"拥塞算法");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_DELAY_FIN_ACK, L"延迟 FIN ACK");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_MAXRTMS, L"重试超时 (精确)");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_FASTOPEN, L"快速打开");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_KEEPCNT, L"保持活动计数");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_KEEPINTVL, L"保持活动间隔");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP, PH_AFD_SOCKET_ITEM_TCP_FAIL_CONNECT_ON_ICMP_ERROR, L"遇到 ICMP 错误时失败");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, L"TCP 信息");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_STATE, L"TCP 状态");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_MSS, L"最大段大小");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_CONNECTION_TIME, L"连接时间");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_TIMESTAMPS_ENABLED, L"已启用时间戳");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_RTT, L"预计往返时间");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_MINRTT, L"最小往返时间");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_BYTES_IN_FLIGHT, L"传输中的字节数");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_CONGESTION_WINDOW, L"拥塞窗口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_SEND_WINDOW, L"发送窗口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_RECEIVE_WINDOW, L"接收窗口");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_RECEIVE_BUFFER, L"接收缓冲区");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_BYTES_OUT, L"发送字节");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_BYTES_IN, L"接收字节");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_BYTES_REORDERED, L"字节重排序");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_BYTES_RETRANSMITTED, L"重传字节");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_FAST_RETRANSMIT, L"快速重传");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_DUPLICATE_ACKS_IN, L"重复 ACK");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_TIMEOUT_EPISODES, L"超时次数");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_SYN_RETRANSMITS, L"SYN 重传");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_RECEIVER_LIMITED_TRANSITIONS, L"接收方限制次数");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_RECEIVER_LIMITED_TIME, L"接收方限制时间");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_RECEIVER_LIMITED_BYTES, L"接收方限制字节");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_CONGESTION_LIMITED_TRANSITIONS, L"受拥塞限制次数");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_CONGESTION_LIMITED_TIME, L"受拥塞限制时间");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_CONGESTION_LIMITED_BYTES, L"受拥塞限制字节");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_SENDER_LIMITED_TRANSITIONS, L"发送方限制次数");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_SENDER_LIMITED_TIME, L"发送方限制时间");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_SENDER_LIMITED_BYTES, L"发送方限制字节");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_OUT_OF_ORDER_PACKETS, L"乱序数据包");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_ECN_NEGOTIATED, L"ECN 协商");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_ECE_ACKS_IN, L"ECE ACK");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_TCP_INFO, PH_AFD_SOCKET_ITEM_TCP_INFO_PTO_EPISODES, L"探测超时次数");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_UDP, L"UDP 级别选项");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_UDP, PH_AFD_SOCKET_ITEM_UDP_NOCHECKSUM, L"无校验和");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_UDP, PH_AFD_SOCKET_ITEM_UDP_SEND_MSG_SIZE, L"最大消息长度");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_UDP, PH_AFD_SOCKET_ITEM_UDP_RECV_MAX_COALESCED_SIZE, L"最大合并大小");

            PhAddIListViewGroup(context->ListViewClass, PH_AFD_SOCKET_GROUP_HVSOCKET, L"Hyper-V 级别选项");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_HVSOCKET, PH_AFD_SOCKET_ITEM_HVSOCKET_CONNECT_TIMEOUT, L"连接超时");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_HVSOCKET, PH_AFD_SOCKET_ITEM_HVSOCKET_CONTAINER_PASSTHRU, L"容器直通");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_HVSOCKET, PH_AFD_SOCKET_ITEM_HVSOCKET_CONNECTED_SUSPEND, L"连接挂起");
            PhAddSocketListViewItem(context->ListViewClass, PH_AFD_SOCKET_GROUP_HVSOCKET, PH_AFD_SOCKET_ITEM_HVSOCKET_HIGH_VTL, L"高 VTL");
