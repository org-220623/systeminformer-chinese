    ...
    )
{
    ...
    {
        PhShowStatus(WindowHandle, L"无法定位调试器。", STATUS_OBJECT_NAME_NOT_FOUND, 0);
        return FALSE;
    }
    ...
    )
{
    ...
    {
        PhShowInformation2(WindowHandle, L"该进程未进行调试。", L"%s", L"");
        return FALSE;
    }
    ...
    )
{
    ...
    config.pszMainInstruction = PhaConcatStrings(5, L"正在尝试", verb, L" ", object, L"...")->Buffer;
    config.cxWidth = 200;
