...
#define PH_LSA_USER_FLAG(x, n)            { TEXT(#x), x, FALSE, FALSE, n }
    static const PH_ACCESS_ENTRY userFlags[] =
    {
        ...
        PH_LSA_USER_FLAG(LOGON_PROFILE_PATH_RETURNED, L"资料路径返回"),
    ...
    )
{
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_LOGON_TYPE, TRUE, L"登陆类型", 100, PH_ALIGN_LEFT, index++, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_LOGON_TIME, TRUE, L"登陆时间", 140, PH_ALIGN_LEFT, index++, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_LOGON_SERVER, FALSE, L"登陆服务器", 180, PH_ALIGN_LEFT, index++, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_LOGON_SCRIPT, FALSE, L"登陆脚本", 180, PH_ALIGN_LEFT, index++, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_PROFILE_PATH, FALSE, L"资料路径", 180, PH_ALIGN_LEFT, index++, 0);
